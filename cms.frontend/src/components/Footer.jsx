      ...
      <div className="container">
        <div className="row g-4 text-start">
          ...
          <div className="col-lg-4 col-md-6">
            ...
            <p className="mt-3" style={{ lineHeight: '1.6', color: '#94a3b8' }}>
              Website bán Đồ Công Nghệ & Gaming Gear (NaUCMS.TechGear). Chúng tôi cam kết cung cấp sản phẩm chính hãng 100%, bảo hành uy tín và dịch vụ chăm sóc khách hàng tận tâm.
            </p>
            <div className="mt-4">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <div className="mt-3">
              <div className="contact-item">
                ...
                <span>63/6 đường 2, Phường Tăng Nhơn Phú B, TP Thủ Đức, TP. Hồ Chí Minh</span>
              </div>
              <div className="contact-item">
                <i className="fa-solid fa-phone mt-1"></i>
                <span>Hotline: 0973 651 140 (8h00 - 22h00)</span>
              </div>
              <div className="contact-item">
                <i className="fa-solid fa-envelope mt-1"></i>
                <span>support@naucmstechgear.vn</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bottom-bar d-flex flex-wrap justify-content-between align-items-center">
          <div className="mb-3 mb-md-0">
            &copy; 2026 <strong>NaUCMS.TechGear</strong>. Bảo lưu mọi quyền. Thiết kế bởi <strong>La Quang Triều</strong>.
          </div>
          <div>
